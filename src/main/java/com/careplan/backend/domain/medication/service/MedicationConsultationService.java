package com.careplan.backend.domain.medication.service;

import com.careplan.backend.domain.medication.dto.ConsultationAnswerRequest;
import com.careplan.backend.domain.medication.dto.ConsultationCreateRequest;
import com.careplan.backend.domain.medication.dto.ConsultationDetailResponse;
import com.careplan.backend.domain.medication.dto.ConsultationListResponse;
import com.careplan.backend.domain.medication.entity.MedicationConsultation;
import com.careplan.backend.domain.medication.repository.MedicationConsultationRepository;
